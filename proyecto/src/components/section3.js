...
import '../App.css'
import album1 from './img/laberinto.jpg'
             ...
             <ul className="collection" style={{borderStyle:'none',width:'745px'}}>
                ...
                <li className="collection-item avatar">
                    ...
                    <i href="https://codepen.io/Kosho969/pen/gRqVRa?editors=0010#0"  className=" btn-floating btn-small waves-effect waves-light purple material-icons circle red">
                      <a href="https://github.com/Kosho969/web/tree/master/laberinto/laberinto">
                      backup
                      </a> 
                    </i>
                  ...
                  <span className="title left">Laberitno</span> <br/>
                  <p className=" left"> Hecho con react y Jquery
                  </p>
